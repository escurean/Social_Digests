...
import { contributionLimiter, flagLimiter } from '../middleware/rateLimiters.js'
...
router.post('/topics/:slug/contributions', authenticate, contributionLimiter, contributionsController.create)
...
router.post('/contributions/:id/flag', authenticate, flagLimiter, contributionsController.flag)
