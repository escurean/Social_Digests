...
export interface ApiCampaignUpdateCampaignUpdate extends Schema.CollectionType {
  collectionName: 'campaign_updates';
  info: {
    singularName: 'campaign-update';
    pluralName: 'campaign-updates';
    displayName: 'Campaign Update';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    campaign: Attribute.Relation<
      'api::campaign-update.campaign-update',
      'manyToOne',
...
export interface ApiDonationCampaignDonationCampaign
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::donation-campaign.donation-campaign', 'title'> &
      Attribute.Required;
    description: Attribute.RichText;
    goal_amount: Attribute.Decimal & Attribute.Required;
    currency: Attribute.Enumeration<['KES', 'USD']> &
      Attribute.DefaultTo<'KES'>;
    topic_slug: Attribute.String;
    beneficiary_name: Attribute.String;
    beneficiary_details: Attribute.Text;
    status: Attribute.Enumeration<
      ['draft', 'active', 'goal_reached', 'expired', 'completed']
    > &
...
export interface ApiEmailTemplateEmailTemplate extends Schema.CollectionType {
  ...
  attributes: {
    ...
    body_html: Attribute.RichText & Attribute.Required;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    show_in_footer: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiSiteSettingSiteSetting extends Schema.SingleType {
  ...
  attributes: {
    platform_name: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Social Digests'>;
    tagline: Attribute.String;
    logo: Attribute.Media<'images'>;
    primary_color: Attribute.String & Attribute.DefaultTo<'#C04000'>;
...
export interface ApiTopicTopic extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::topic.topic', 'title'> & Attribute.Required;
    ...
    >;
    status: Attribute.Enumeration<['draft', 'active', 'closed', 'archived']> &
      Attribute.DefaultTo<'draft'>;
    proposed_by: Attribute.String;
...
export interface ApiTopicCategoryTopicCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::topic-category.topic-category', 'name'> &
      Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::campaign-update.campaign-update': ApiCampaignUpdateCampaignUpdate;
